class CgalAT502 < Formula
  desc "Computational Geometry Algorithms Library: v.5.0.2"
  ...
  bottle do
    ...
    sha256 "ca34492b9bc5ae5bc125c1ac7439e1a6fcefdb228d825a8058471a2a82203a1d" => :catalina
  end
