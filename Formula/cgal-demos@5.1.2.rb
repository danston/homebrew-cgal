class CgalDemosAT512 < Formula
  desc "Computational Geometry Algorithms Library: Demos v.5.1.2"
  homepage "https://www.cgal.org/"
  url "https://github.com/CGAL/cgal/releases/download/v5.1.2/CGAL-5.1.2.tar.xz"
  sha256 "e499ad8199580fa979a5a6e431e667c22ca2892ebbb7981e699849060645341d"
  ...
  def install
    args = std_cmake_args + %W[
      ...
      -DOpenCV_DIR=#{HOMEBREW_PREFIX}/opt/opencv@3/share/OpenCV
    ]
    ...
    puts "\nInstalling demos for CGAL 5.1.2..."
